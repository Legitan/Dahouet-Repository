...
-- Export de données de la table dahouet.proprietaire : ~16 rows (environ)
DELETE FROM `proprietaire`;
/*!40000 ALTER TABLE `proprietaire` DISABLE KEYS */;
INSERT INTO `proprietaire` (`Num_proprietaire`, `Num_club`, `Nom_proprietaire`, `Coordonnees_proprietaire`) VALUES
	(1, 1, 'Rotshild', 'Marseille'),
	(2, 2, 'Francois', 'Dijon'),
	(3, 3, 'Fensworth', 'Rennes'),
	(4, 4, 'Naty', 'Nostan'),
	(5, 2, 'Francis Lalane', 'Vannes'),
	(6, 3, 'Dechavanne', 'Nostan'),
	(7, 1, 'Debanne', 'Singapour'),
	(8, 4, 'Dorothée', 'Londres'),
	(9, 1, 'Die Antwoord', 'Barcelonne'),
	(10, 4, 'F. Hollande', 'Paris'),
	(11, 3, 'Lionnel MeuhMeuh', 'Langueux'),
	(12, 2, 'Bond', 'NY'),
	(106, 3, 'Barbe Beige', 'Tortuga');
...
-- Export de données de la table dahouet.voilier : ~17 rows (environ)
DELETE FROM `voilier`;
